...
//      Set Alignment
		    ...
		    slider_y.addChangeListener(new ChangeListener() {
			  ...
			  /*   try {
				...
				/*    ftotal=0;
			    	...
			    	//Energy.setCurrentValue((float)disp/100,(float)((utotal_dihed)));      // Note that disp denotes the net displacement.  
			    	Energy.addGraphValue((float)(2*100*utotal_dihed));//-freeBody.getDisplacment()*500))
			    	Energy.drawGraph();
			    	Energy.setYScale(10);
			    	
			    	Force.setState(1);
			    	//Force.setCurrentValue((float)disp/200,(float)ftotal_dihed/1000);        
			        Force.addGraphValue((float)ftotal_dihed/10000);//-freeBody.getDisplacment()*500));
			        Force.drawGraph();
			        Force.setYScale(10);
			        }
		    });
	...
	slider_y.setBackground(bk);
     ...
     value_12.addChangeListener(new ChangeListener() {
		    public void stateChanged(ChangeEvent e) {
		    	double temp=((double)((JSlider) e.getSource()).getValue());
		    	System.out.println("k value "+dihed_k[0]);
		    	bond_k[0]=temp*40;
		    }
	 });
     ...
     distance_12.addChangeListener(new ChangeListener() {
		    public void stateChanged(ChangeEvent e) {
		    	double temp=((double)((JSlider) e.getSource()).getValue());
		    	System.out.println("r value "+dihed_theta[0]);
     ...
     value_23.addChangeListener(new ChangeListener() {
		    public void stateChanged(ChangeEvent e) {
		    	...
		    	System.out.println("1 k value "+dihed_k[1]);
		    	bond_k[1]=temp2*40*4;
		    }
	 });
     ...
     distance_23.addChangeListener(new ChangeListener() {
		    public void stateChanged(ChangeEvent f) {
		    	...
		    	System.out.println("r value 2"+dihed_theta[1]);
