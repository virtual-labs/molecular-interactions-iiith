 ...
 */
public class Millikan extends javax.swing.JPanel {
	
	static float ftotal_nonbond=1000;
    static float utotal_nonbonded=1000;
...
////////////////////////////Java3D componenet ///////////////////////////
    ...
    Point2D m_acc=new Point2D.Float(6, 4.8f); 
...
/*    private BranchGroup createPlottedGraph(Vector3d pos,Vector3d scale,Color3f colr) {
     ...
     private Group CreateLabSetup() {
    	...
    	objtrans.setCapability(TransformGroup.ALLOW_TRANSFORM_READ); 
 	    ...
 	    atom3.addChild(m_j3d.createSphere(new Vector3d(-0.175,0.475,-1), 0.008f, new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
	    
 	    tr=new Transform3D();
	    TransformGroup atom31 = new TransformGroup(tr);
	    atom31.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	    atom31.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
	    atom31.addChild(m_j3d.createSphere(new Vector3d(-0.225,0.5,-1), 0.008f, new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
 	    
	    tr=new Transform3D();
 	    TransformGroup atom32 = new TransformGroup(tr);
 	    atom32.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
 	    atom32.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
 	    atom32.addChild(m_j3d.createSphere(new Vector3d(-0.125,0.51,-1), 0.008f, new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
	    ...
	    atom4.addChild(m_j3d.createSphere(new Vector3d(-0.15,0.525,-1), 0.008f, new Color3f(0,1,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
 	    
	    tr=new Transform3D();
	    TransformGroup atom41 = new TransformGroup(tr);
	    atom41.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	    atom41.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
	    atom41.addChild(m_j3d.createSphere(new Vector3d(-0.2,0.5,-1), 0.008f, new Color3f(0,1,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
 	    
	    tr=new Transform3D();
	    TransformGroup atom42 = new TransformGroup(tr);
	    atom42.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	    atom42.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
	    atom42.addChild(m_j3d.createSphere(new Vector3d(-0.1,0.48,-1), 0.008f, new Color3f(0,1,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
 	    
	    
   	    hm.put("atom3", atom3);
   	    hm.put("atom4", atom4);
   	    
   	    hm.put("atom32", atom32);
	    hm.put("atom42", atom42);
	    
	    hm.put("atom31", atom31);
   	    hm.put("atom41", atom41);
   	
    	objtrans.addChild(atom3);
    	objtrans.addChild(atom4);
    	
    	objtrans.addChild(atom31);
    	objtrans.addChild(atom41);
    	
    	objtrans.addChild(atom32);
    	objtrans.addChild(atom42);
    	
    	/*************** BIG MOLECULES ******************/
    	tr=new Transform3D();
 	    TransformGroup atombig = new TransformGroup(tr);
 	    atombig.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
 	    atombig.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
 	    atombig.addChild(m_j3d.createSphere(new Vector3d(0.4,0.2,0.5), 0.02f, new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
	    
 	   tr=new Transform3D();
	    TransformGroup atombig2 = new TransformGroup(tr);
	    atombig2.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	    atombig2.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
	    atombig2.addChild(m_j3d.createSphere(new Vector3d(0.4,0.2,0.5), 0.02f, new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
    	
	    hm.put("atombig", atombig);
   	    hm.put("atombig2", atombig2);
   	
    	objtrans.addChild(atombig);
    	objtrans.addChild(atombig2);
 	   ...
 	   Cylinder cylinder_into = new Cylinder(0.091f,0.048f,ap);
 	    
 	  // tr.setTranslation(new Vector3d(0,delta,0));
 	   
 	   tr = new Transform3D();
  	  tr.setTranslation(new Vector3d(-0.1,delta/2-0.02,0));
	    ...
	    tr = new Transform3D();
	  	tr.setTranslation(new Vector3d(-0.1,delta/2-0.02-0.25,0));
	  	tg.setTransform(tr);
	  	tg.addChild(cylinder_into);
	    ...
	    tg = new TransformGroup();
  		...
  		//objtrans.addChild(createBox(new Vector3d(-.15+0.15/2-0.015, -0.22+delta, .2f),new Vector3d(.3/2.9,.01,.01), new Color3f(.5f, 0.0f, 0f)));
  		objtrans.addChild(createBox(new Vector3d(-.15+0.15/2-0.015, -0.22+delta-0.175, .2f),new Vector3d(.3/3.5,.01,.01), new Color3f(.09f, 0.0f, 0f)));
	    ///////////////////////   Microscopic View /////////////////
	  ...
	  /*  hm.put(sphere,"sphere");
    	...
    	tr = new Transform3D();
    	objtr=(TransformGroup)hm.get("sphere");
    	System.out.println("HERE"+objtr);
    	objtr.getTransform(tr);
    	tr.setTranslation(new Vector3d(0,trans,0));
	...
	*/    
	/*    OilDrop oil2= new OilDrop(new Vector3d(0.47,0.32,0.6),new Vector3d(0,-1,0) ,new Vector3d(.2,.2,.2), tg , new Vector3d(-0.2,-0.5,0.0) ,new Vector3d(0.2,0.8,.0));
	    ...
	    */
    	...
    	support1.addChild(m_j3d.createCylinder(0.01f,0.48f, new Vector3d(0,0,0),new Vector3d(1,1,1) ,new Vector3d(0,0,0), new Color3f(0.5f,0.5f,0.5f), "hello",hm));
    	tr.setTranslation(new Vector3d(-0.25,-0.05,0));/////
    	...
    	support2.addChild(m_j3d.createCylinder(0.04f,(float)0.01, new Vector3d(0,0,0), new Vector3d(1,1,1),new Vector3d(0,0,0), new Color3f(0.5f,0.5f,0.5f), "hello",hm));
    	tr.setTranslation(new Vector3d(-0.2,0.15,0));/////
    	support2.setTransform(tr);
    	
    	objtrans.addChild(support2);
    	
    	tr=new Transform3D();
    	TransformGroup support3 = new TransformGroup(tr);
    	support3.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
    	support3.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
    	support3.addChild(m_j3d.createCylinder(0.04f,(float)0.01, new Vector3d(0,0,0), new Vector3d(1,1,1),new Vector3d(0,0,0), new Color3f(0.5f,0.5f,0.5f), "hello",hm));
    	tr.setTranslation(new Vector3d(-0.2,-0.15,0));/////
    	support3.setTransform(tr);
...
//  	 assign the visibility mask to the Switch
     ...
     */
    public Millikan(Container container) {
    ...
    private static class MyFrame extends JFrame {
        MyFrame() {
            ...
            setTitle("Chromatograph Experiment");
            getContentPane().add(new Millikan(this), BorderLayout.CENTER);
            pack();
        }
    }
    ...
    public static void nonbond_force () throws NumberFormatException, IOException
	{
    	...
    	distance_single=(float)((float)Math.abs(trans-trans2)+0.00000000001) ;
    	//if (distance_single> 100)
    		//distance_single=100;
...
//    			app.setColoringAttributes(ca);
    ...
    private void timerActionPerformed(java.awt.event.ActionEvent evt) throws NumberFormatException, IOException {//GEN-FIRST:event_resumeButtonActionPerformed
    	...
    	/**********/
    	Transform3D tr = new Transform3D();
    	TransformGroup objtransand=(TransformGroup)hm.get("atom3");
       	System.out.println(objtransand);
       	
       	objtransand.getTransform(tr);
       	tr.setTranslation(new Vector3d(0,trans, 0));
       	System.out.println(trans);
       	objtransand.setTransform(tr);
       	/***************/
       	
       	Transform3D tr11 = new Transform3D();
       	objtransand=new TransformGroup();
    	objtransand=(TransformGroup)hm.get("atom31");
       	System.out.println(objtransand);
       	
       	objtransand.getTransform(tr11);
       	tr11.setTranslation(new Vector3d(0,trans, 0));
       	System.out.println(trans);
       	objtransand.setTransform(tr11);
    	/**********/
       	tr = new Transform3D();
    	objtransand=(TransformGroup)hm.get("atom32");
       	System.out.println(objtransand);
    	...
    	objtransand=(TransformGroup)hm.get("atom4");
       	System.out.println(objtransand);
       	
       	objtransand.getTransform(tr1);
       	tr1.setTranslation(new Vector3d(0,trans2, 0));
       	System.out.println(trans);
       	objtransand.setTransform(tr1);
    	/**********/
       	tr1 = new Transform3D();
    	objtransand=(TransformGroup)hm.get("atom41");
       	System.out.println(objtransand);
    	...
    	/**********/
       	tr1 = new Transform3D();
    	objtransand=(TransformGroup)hm.get("atom42");
       	//System.out.println(objtransand);
    	...
    	/**********/
       	...
       	if (trans< -0.31 && trans> -0.57)
       	{
       	  	
           	tr1 = new Transform3D();
        	objtransand=(TransformGroup)hm.get("atombig");
        	System.out.println("gooo   "+objtransand);
           	
           	objtransand.getTransform(tr1);
           	tr1.setTranslation(new Vector3d(0,trans*2, 0));
           	objtransand.setTransform(tr1);
    	...
    	nonbond_energy();
     	nonbond_force();
       	...
       	if (utotal_nonbonded > 8/8)
       		utotal_nonbonded=8/8;
       	Energy.setState(1);
    	...
    	if (ftotal_nonbond > 8*200)
    		ftotal_nonbond=8*200;
    	Force.setState(1);
    	Force.setCurrentValue((float)disp/200,(float)ftotal_nonbond/10);        
        Force.addGraphValue((float)ftotal_nonbond/200);//-freeBody.getDisplacment()*500));
        Force.drawGraph();
        Force.setYScale(10);
        
    	//oilnew.update(0.0008);
    	r_clock += 0.0008f;
    	if(timer_on) {
    		lapase +=0.0008;
    		if(fallOrRise){
    ...
    /*	TransformGroup objtr;
    	Transform3D tr = new Transform3D();
    	objtr=(TransformGroup)hm.get("oil");
...
/*    	OilDrop oil=  (OilDrop) hm.get("oil");
   ...
   */ 	
    /*	Transform3D tr = new Transform3D();
    	TransformGroup objtr=(TransformGroup)hm.get("support1");
    	objtr.getTransform(tr);
...
class SniperView2 extends Shape3D   {
	public SniperView2(Vector3d min, Vector3d max, float step, Color3f colr) {
	    super();
...
class PowerSys2 extends Shape3D   {
...
class Line2 extends Shape3D   {
	
	  public Line2(Point3d p1, Point3d p2,Color3f colr) {
		    super();  	    
