...
//	JSlider center1;
	...
	static float tempq1=(float) 0.10;
	static float tempq2=(float) 0.10;
...
//		tr=new Transform3D();
    ...
    //	First Atom 	
    	...
    	atom1.addChild(m_j3d.createSphere(new Vector3d(-0.5,0,0), 0.06f, new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
    ...
    //  Second Atom
    	...
    	atom2.addChild(m_j3d.createSphere(new Vector3d(0.5,0,0), 0.06f, new Color3f(1,0,0), new Color3f(0,1,0), new Color3f(1,0,0), new Color3f(1,0,1), 3.0f));
...
/*			if(result[0].equals("ATOM")) :CHANGE FORMAT WHEN NECCESSARY	*/
	...
	/*			if(result[0].equals("ATOM")) :CHANGE FORMAT WHEN NECCESSARY	*/
		...
		/*			if(result[0].equals("ATOM")) :CHANGE FORMAT WHEN NECCESSARY	*/
		 ...
		 public static void move_single()
			{
			 float templol=(float) (magnet_x_translate-magnet_x1_translate);
			 System.out.println("Look "+templol);
			 distance_single=(float) (Math.sqrt(Math.pow((magnet_y_translate-magnet_y1_translate),2))+Math.pow((magnet_x_translate-magnet_x1_translate-1),2)+Math.pow((magnet_z_translate-magnet_z1_translate),2));
    ...
    /*	for (int j=2;j<= iter_nonbond ;j++)
		...
		//float du_dr=tempe*((12*pow12/distance)-2*(6*pow6/distance));
    	float square=(float) ((float) Math.pow(distance_single,2));
		float dq_dr=(float) ((tempq1*tempq2)/square);
		ftotal_nonbond=dq_dr;
		    ...
		    public void stateChanged(ChangeEvent e) {
				...
				/*    ftotal=0;
					...
					{			
			        	...
			        	tr.setTranslation(new Vector3d(temp,magnet_y_translate,magnet_z_translate));
			    	...
			    	Energy.addGraphValue((float)(utotal_nonbonded*40));//-freeBody.getDisplacment()*500))
			    	Energy.drawGraph();
			    	Energy.setYScale(10);
			    	
			    	Force.setState(1);
			    	Force.setCurrentValue((float)disp/200,(float)ftotal_nonbond/10);        
			        Force.addGraphValue((float)ftotal_nonbond*3);//-freeBody.getDisplacment()*500));
			        Force.drawGraph();
			        Force.setYScale(10);
					}
		    }
		    ...
		    slider_y.addChangeListener(new ChangeListener() {
				...
				//System.out.println("disp"+disp);
					...
					{	
				    	...
				    	tr.setTranslation(new Vector3d(magnet_x_translate,temp,magnet_z_translate));
			        	objtr.setTransform(tr);
		    ...
		    public void stateChanged(ChangeEvent e) {
				...
				/*    ftotal=0;
					...
					if ( distance_single > 0.08)	  
					{
			        	...
			        	tr.setTranslation(new Vector3d(magnet_x_translate,magnet_y_translate,temp));
...
/*	 javax.swing.JPanel temp;
	...
	*/ 
	...
	second.setBackground(bk);
	JLabel lbl1 = new JLabel("Charge Atom1", JLabel.LEFT);
    slider_sg1 = new JSlider(JSlider.HORIZONTAL,  -16,16 , 5);
    slider_sg1.addChangeListener(new ChangeListener() {
	    public void stateChanged(ChangeEvent e) {
	    	...
	    	//tr.setTranslation(new Vector3d(-magnet_x_translate,-magnet_y_translate,-magnet_z_translate));
	    	//objtr.setTransform(tr);
	    	//objtr.getTransform(tr);
    ...
    slider_sg1.setBackground(bk);
   	...
   	lbl1 = new JLabel("Charge Atom2", JLabel.LEFT);
    slider_sg2 = new JSlider(JSlider.HORIZONTAL,  -16,16 , 5);
  ...
  */ 
        ...
        // *************************************for the movement
            ...
            //	System.out.println("NET Translation is" + 0.54);
          	...
          	//Scaling=0.6-magnet_x_translate/2;
          	//double temp_Scalingx=0.6+magnet_x_translate/2;
        	//net_translation=-0.535;
            //	System.out.println("NET Translation is" + 0.54);
