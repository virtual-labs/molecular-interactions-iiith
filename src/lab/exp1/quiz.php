...
<center><button class="boundingBox1" onclick='window.location="http://mi-iiith.vlabs.ac.in/exp1/Experiment.html?domain=Chemical%20Sciences&lab=Molecular%20Interaction";'><strong>Back To Experiment<string></button>
