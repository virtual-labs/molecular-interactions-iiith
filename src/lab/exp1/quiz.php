...
<t><button class="boundingBox1" onclick='window.location="./Theory.html?domain=Chemical Sciences&lab=Molecular Interaction";'><strong>Back To Theory<string></button></center>
